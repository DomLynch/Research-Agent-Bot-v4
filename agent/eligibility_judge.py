...
_SYSTEM_PROMPT = (
    ...
    "paraphrase a quote.\n\n"
    "EVIDENCE QUOTES - extract AT LEAST TWO verbatim quotes per include "
    "decision: one from the methods/intervention sentences ('we treated X "
    "with Y'), one from the results sentences ('survival was extended by N "
    "percent', 'median lifespan was N days'). Do NOT quote the title alone - "
    "the title is metadata, not evidence. Quotes from background, "
    "introduction framing, or other authors' prior work do not count.\n\n"

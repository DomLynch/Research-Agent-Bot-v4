# Alpha memo — allostatic_load

**Headline:** No signal — allostatic_load
**Alpha triage:** `none` (internal ranking; not a certainty claim)
**Confidence:** `no_signal`
**Memo surface:** `curation brief`
**Snapshot:** `2026-05-27T05-36-12Z`
**Run:** `allostatic_load-evidence-2026-05-27T05-36-12Z`
**Direct source breadth:** `0` direct cited source(s)
**Source breadth:** `0/5` unique cited source(s)

## One-sentence thesis

The memo advances a bounded evidence signal under this headline: No signal — allostatic_load.
...
- **Suggested citation:** Dom Lynch. (2026). No signal — allostatic_load. ReseaRka Evidence Index. Version 1.0.
- **Run bundle SHA-256:** `dbcab701bd4dfc39219f545b6cc846349eff56880897cc97872773673894fcec`
- **Memo SHA-256:** `985de7444a2794f917297e461cc1ad1e60ed4a310b69c3b0a7db9534581abac4`

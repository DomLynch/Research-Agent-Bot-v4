# Alpha memo — low_dose_lithium

**Headline:** No signal — low_dose_lithium
**Alpha triage:** `none` (internal ranking; not a certainty claim)
**Confidence:** `no_signal`
**Memo surface:** `curation brief`
**Snapshot:** `2026-05-26T18-52-31Z`
**Run:** `low_dose_lithium-evidence-2026-05-26T18-52-31Z`
**Direct source breadth:** `0` direct cited source(s)
**Source breadth:** `0/5` unique cited source(s)

## One-sentence thesis

The memo advances a bounded evidence signal under this headline: No signal — low_dose_lithium.
...
- **Topic:** `low_dose_lithium`
- **Author:** Dom Lynch
- **ORCID:** _not configured_
- **Version:** 1.0
- **License:** CC BY-NC 4.0
- **Canonical URL:** _not assigned_
- **Suggested citation:** Dom Lynch. (2026). No signal — low_dose_lithium. ReseaRka Evidence Index. Version 1.0.
- **Run bundle SHA-256:** `686626bf5bfa76b408f0a0fc4f0bb38db98b3da7c556470ee2a30d102987d422`
- **Memo SHA-256:** `186d38c48c954de4581db9f6d359c1d3c751a3fc662ecbc58263eaa52cf60f52`

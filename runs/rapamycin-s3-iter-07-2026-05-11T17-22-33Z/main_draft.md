...
### Study Selection
Of 500 records identified through systematic database search, 500 were screened at title/abstract level; 65 were flagged as candidate full-text inclusions pending full-text retrieval and eligibility assessment. Full-text retrieval is recorded for 57 candidates, of which 0 met all inclusion criteria for the primary pooled analysis [PACKET:study_selection].

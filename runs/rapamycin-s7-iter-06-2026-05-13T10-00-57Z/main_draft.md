...
### Study Selection
Of 692 records identified through systematic database search, 692 were screened at title/abstract level; 341 were flagged as candidate records for full-text retrieval. Open-access full-text availability was located for 270 candidates; full-text content was parsed for 147 of these. Pre-specified eligibility adjudication was applied to 147 records, yielding 21 auto-eligible records (universal evidence contract passed), 116 excluded, 10 flagged for manual review of low-confidence or rule-judge conflicts; the subset of strict A-core records is the canonical input for primary-effect extraction [PACKET:study_selection].
...
The 21 auto-eligible records span publication years 2009-2026 and 14 distinct venues [PACKET:corpus_characteristics].

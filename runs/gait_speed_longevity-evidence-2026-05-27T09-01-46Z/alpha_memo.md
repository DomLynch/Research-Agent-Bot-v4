# Alpha memo — gait_speed_longevity

**Headline:** No signal — gait_speed_longevity
**Alpha triage:** `none` (internal ranking; not a certainty claim)
**Confidence:** `no_signal`
**Memo surface:** `curation brief`
**Snapshot:** `2026-05-27T09-01-46Z`
**Run:** `gait_speed_longevity-evidence-2026-05-27T09-01-46Z`
**Direct source breadth:** `0` direct cited source(s)
**Source breadth:** `0/5` unique cited source(s)

## One-sentence thesis

The memo advances a bounded evidence signal under this headline: No signal — gait_speed_longevity.
...
- **Topic:** `gait_speed_longevity`
- **Author:** Dom Lynch
- **ORCID:** _not configured_
- **Version:** 1.0
- **License:** CC BY-NC 4.0
- **Canonical URL:** _not assigned_
- **Suggested citation:** Dom Lynch. (2026). No signal — gait_speed_longevity. ReseaRka Evidence Index. Version 1.0.
- **Run bundle SHA-256:** `6d130fb153bbcebbe9b78cd28b142266508e7bd79412282ebb3a2abde7ccb239`
- **Memo SHA-256:** `12ceda6853b36431c913c6d035f7143bac37d8a6e9a334d68a31e4f478603ee8`

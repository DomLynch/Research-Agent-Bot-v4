# Alpha memo — cold_exposure_brown_fat

**Headline:** No signal — cold_exposure_brown_fat
**Alpha triage:** `none` (internal ranking; not a certainty claim)
**Confidence:** `no_signal`
**Memo surface:** `curation brief`
**Snapshot:** `2026-05-27T09-53-01Z`
**Run:** `cold_exposure_brown_fat-evidence-2026-05-27T09-53-01Z`
**Direct source breadth:** `0` direct cited source(s)
**Source breadth:** `0/5` unique cited source(s)

## One-sentence thesis

The memo advances a bounded evidence signal under this headline: No signal — cold_exposure_brown_fat.
...
- **Topic:** `cold_exposure_brown_fat`
- **Author:** Dom Lynch
- **ORCID:** _not configured_
- **Version:** 1.0
- **License:** CC BY-NC 4.0
- **Canonical URL:** _not assigned_
- **Suggested citation:** Dom Lynch. (2026). No signal — cold_exposure_brown_fat. ReseaRka Evidence Index. Version 1.0.
- **Run bundle SHA-256:** `a679392691799646ebcd340a4cc996a8bd2b9a09e45da9155f579386f5eb5525`
- **Memo SHA-256:** `9fdc928bbb6e1d4f7bb0849084cbd08e4a28ce1b3e30da86f7931d012dde2733`

# Alpha memo — statins_longevity

**Headline:** No signal — statins_longevity
**Alpha triage:** `none` (internal ranking; not a certainty claim)
**Confidence:** `no_signal`
**Memo surface:** `curation brief`
**Snapshot:** `2026-05-27T06-27-03Z`
**Run:** `statins_longevity-evidence-2026-05-27T06-27-03Z`
**Direct source breadth:** `0` direct cited source(s)
**Source breadth:** `0/5` unique cited source(s)

## One-sentence thesis

The memo advances a bounded evidence signal under this headline: No signal — statins_longevity.
...
- **Topic:** `statins_longevity`
- **Author:** Dom Lynch
- **ORCID:** _not configured_
- **Version:** 1.0
- **License:** CC BY-NC 4.0
- **Canonical URL:** _not assigned_
- **Suggested citation:** Dom Lynch. (2026). No signal — statins_longevity. ReseaRka Evidence Index. Version 1.0.
- **Run bundle SHA-256:** `1fe2ea803cbafdb65a25580c333f33aee13d5b17652dbb52e700009bf2aecbd3`
- **Memo SHA-256:** `222128fbbaa2d7c31d84438ad16d93cf0606bc0b13c14708e7fed78e645a5293`

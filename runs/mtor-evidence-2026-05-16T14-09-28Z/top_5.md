...
- **Why it matters:** Metformin's 72% reduction in tumor burden in mice suggests it could be repurposed as a chemopreventive agent for smoking-related cancers by targeting mTOR.
- **Caution:** This study relied on a single mouse model (A/J mice with NNK carcinogen), and the metformin dose used may not reflect human tolerability or efficacy.
- **Next question:** Does metformin inhibit mTOR and reduce tumor growth in human smokers at safe, clinically relevant doses?
...
- **Why it matters:** The 40% mortality in mTOR-hypomorphic mice highlights mTOR's vital role in survival, indicating its involvement in essential physiological processes beyond cancer.
- **Caution:** The knock-in mouse model may not fully mimic human mTOR deficiencies, and the specific causes of mortality were not identified in this finding.
- **Next question:** What are the precise biological pathways through which mTOR hypomorphism leads to increased mortality, and do similar vulnerabilities occur in humans?

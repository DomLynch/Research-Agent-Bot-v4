...
### Study Selection
Of 502 records identified through systematic database search, 502 were screened at title/abstract level; 5 were flagged as candidate records for full-text retrieval. Open-access full-text availability was located for 5 candidates; full-text content was parsed for 5 of these. Pre-specified eligibility adjudication was applied to 5 parsed records, yielding 0 included, 5 excluded, and 0 flagged for manual review of low-confidence or rule-judge conflicts for the primary pooled analysis [PACKET:study_selection].

### Sentinel Recall Audit
Sentinel-paper recall audit (gate: PASS): 3/3 canonical primary-study anchors retrieved (0 promoted to candidate set); 1/1 prior meta-analysis anchors retrieved [PACKET:sentinel_recall].

...
def test_seed_fullraw_reserves_strict_fullraw_inflight_headroom(
    monkeypatch: Any,
) -> None:
    run_topic_discovery._FULLRAW_PROBE_EVENTS.clear()
    monkeypatch.setenv("V5_MEMO_FULL_RAW_INDEX_TOKEN", "tok")
    ...
    def handler(req: Any) -> Any:
        ...
        raise AssertionError("search should wait for reserved fullraw headroom")
...
def test_seed_fullraw_priority_polls_recent_in_progress_receipt(
    ...
    def fake_fetch(query: str, *_args: Any, **_kwargs: Any) -> list[dict[str, Any]]:
        ...
        return [{
            "doi": "10.1/platform",
            "title": "Priority platform strategy receipt",
            "fullraw_shard_receipt": receipt,
        }]

...
def _fullraw_supply_parent_timeout_default() -> int:
    raw_budget = (
        os.environ.get("TOPIC_DISCOVERY_FULLRAW_SUPPLY_BUDGET_SECONDS")
...
_EXPLORATORY_DISCOVERY_FLOOR = 20
_STOP_ON_READY_DISCOVERY_FLOOR = 4
...
def _discovery_top_for_plan(
    ...
    if not stop_on_ready:
        return max(requested, _EXPLORATORY_DISCOVERY_FLOOR)
